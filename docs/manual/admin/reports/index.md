...
![The reports page](reports.webp)

Each row shows the post that was reported, its author, the reason given, who
...
has reported anything on shows a message instead of an empty table.

The post links through to where it was posted. The reason on its own tells you
how someone felt rather than what was written.

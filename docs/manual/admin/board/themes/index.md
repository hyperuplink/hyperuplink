...
![The themes page](themes.webp)

## Theme and colorscheme

A _theme_ decides what a window, a button, a menu and a scrollbar look like, and
the board ships with a number of them: _macos9_, _win3x_, _win9x_,
...
separately, hence a macOS 9 board in _Gruvbox_ is a thing you can have, whether
or not it's a thing you should have. A board with nothing picked
...
shows a message until you've picked and saved one, because a file has to go
somewhere before it can be uploaded. The providers come from the board's
configuration file.

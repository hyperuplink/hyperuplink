		...
		return []MenuItem{
			{
				...
				SubItems: []MenuItem{
					...
					{
						Label: m.T(route.For("AdminPermissions").AsTitle()),
						Title: m.T(route.For("AdminPermissions").AsTitle()),
						Href:  route.For("AdminPermissions").AsURL(),
					},
					{
						IsSeparator: true,
					},
					{
						Label: m.T(route.For("AdminReports").AsTitle()),
						Title: m.T(route.For("AdminReports").AsTitle()),
						Href:  route.For("AdminReports").AsURL(),
					},
					{
